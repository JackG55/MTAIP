...
export default function BasicTabs(props) {
    ...
    const { items, itemsCategory1, itemsCategory2, itemsCategory3, itemsCategory4, itemsCategory5 } = props;
        ...
        <Box sx={{ width: 'auto' }}>
            <Box sx={{ borderBottom: 1, borderColor: 'divider', color: 'black' }}>
                <Tabs value={value} onChange={handleChange} textColor='inherit' indicatorColor='primary' aria-label="basic tabs example" >
                    ...
                    <Tab label="Tạo hình, mỹ thuật ứng dụng" {...a11yProps(1)} sx={{ fontSize: '16px' }} />
                    <Tab label="Nhiếp ảnh" {...a11yProps(2)} sx={{ fontSize: '16px' }} />
                    <Tab label="Kiến trúc" {...a11yProps(3)} sx={{ fontSize: '16px' }} />
                    <Tab label="Sơ đồ, bản vẽ" {...a11yProps(4)} sx={{ fontSize: '16px' }} />
                    <Tab label="Nhãn hiệu" {...a11yProps(5)} sx={{ fontSize: '16px' }} />
                </Tabs>
            </Box>
